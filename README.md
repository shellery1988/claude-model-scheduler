...
```bash
curl -fsSL https://raw.githubusercontent.com/shellery1988/claude-model-scheduler/main/install.sh | bash
```
...
```bash
git clone https://github.com/shellery1988/claude-model-scheduler.git
